...
<head>
  ...
  ================================================== -->
    ...
    <link rel="stylesheet" href="${pageContext.request.contextPath}/http://cdn.static.runoob.com/libs/bootstrap/3.3.7/css/bootstrap.min.css">
                    ...
                    <div class="container-fluid">
                        <div class="collapse navbar-collapse" id="example-navbar-collapse">
                            <ul class="nav navbar-nav">
                                ...
                                <li class="active"><a href="${pageContext.request.contextPath}/author/collection">我的书架</a></li>
                ...
                <table class="table table-striped">
                    ...
                    <c:forEach items="${requestScope.novelList}" var="novel">
                        <tr class="text-center">
                            ...
                            <td><f:formatDate value="${novel.createDate}" pattern="yyyy-MM-dd"/> </td>
                            <td>${novel.readNow}</td>
                            ...
                            <td><button type="button" class="btn btn-danger" style="height: 30px;width: 100px">
                                <span class="glyphicon glyphicon-minus-sign"></span> <a href="/user/delCollection?id=${novel.id}&userId=${novel.userId}">删除</a>
                            </button></td>
                        </tr>
                    </c:forEach>
                    </tbody>
