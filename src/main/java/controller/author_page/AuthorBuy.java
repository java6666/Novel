...
public class AuthorBuy {
    ...
    @Resource
    private NovelUserBuyDao novelUserBuyDao;

    @RequestMapping(path = "/author/buy", method = RequestMethod.GET)
    public String userBuy(HttpSession session, Model model) {
        ...
        return "/WEB-INF/author_center/author_buy_books.jsp";
    }
}
